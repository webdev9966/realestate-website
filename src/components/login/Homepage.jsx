...
export default class Homepage extends Component {
  ...
  getProduct = () => {
    ...
    axios.get(`http://localhost:5000/get-product${data}`, {
      headers: {
  ...
  deleteProduct = (id) => {
    axios.post('http://localhost:5000/delete-product', {
      id: id
    }, {
      headers: {
  ...
  addProduct = () => {
    ...
    axios.post('http://localhost:5000/add-product', file, {
      headers: {
            ...
            <TableBody>
              {this.state.products.map((row) => (
                <TableRow key={row.name}>
                  ...
                  <TableCell align="center"><img src={`http://localhost:5000/${row.image}`} style={{width: 70, height:70 }} alt='name'/></TableCell>
